        ...
        <div id="container">
            ...
            <div id="board">
                ...
                <form action="" method="post" onsubmit="return false;">
					<input type="hidden" name="num" value=${processInfo.num }>
					<input type="hidden" name="sessId" value=<%=sessId %>>
					<input type="hidden" id="writer_id" name="writer_id" value=${processInfo.writer_id }>
        ...
        $(function () {
            ...
            $("#update_btn").click(function () {
            	if(sessId == id) {
            		...
            		$("form").attr("action", "/project2/process/modProcessForm").submit();
            	} else {
            		alert("접근 권한이 없습니다.");
            	}
            });
			...
			$("#delete_btn").click(function () {
            	...
            	if(sessId == id || sessId == "admin") {
                	...
                	if(result){
    	                alert("삭제가 완료되었습니다.");
    	                $("form").attr("onsubmit", "return true;");
    	                $("form").attr("action", "/project2/process/delProcess").submit();
                	}
            	} else {
            		alert("접근 권한이 없습니다.");
            	}
            ...
            $("#list_btn").click(function () {
            	window.location.href = '/project2/process/listProcess';
            });
        });
