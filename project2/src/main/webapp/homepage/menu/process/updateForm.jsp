            ...
            <div>
                ...
                <div>
                    ...
                    <form action="" method="post" onsubmit="return false;">
						...
						<input type="hidden" name="writer_id" value=${processInfo.writer_id }>
                        <br>
                        ...
                        <div id="title">
                            ...
                            <div>
                            	<textarea cols="130" rows="1" id="title_text" name="title" style="resize: none;"
                                    autocomplete="off" placeholder="제목을 입력하세요.">${processInfo.title }</textarea>                     
                            </div>
                        ...
                        <div id="content">
                            ...
                            <div>
                                <textarea cols="130" rows="10" id="content_text" name="content" style="resize: none;"
                                    placeholder="내용을 입력하세요.">${processInfo.content }</textarea>
                            </div>
                        ...
                        <div id="writer">
                            ...
                            <div>
                                <textarea cols="130" rows="1" id="writer_text" name="writer" style="resize: none;"
                                    readonly>${processInfo.writer }</textarea> 
                            </div>
			...
			$("#insert_btn").click(function(){
				if(title.value == "" || content.value == "" || writer.value == "") {
					...
					if(writer.value.length > 6) {
						...
						$("form").attr("action", "/project2/process/modProcess").submit();
					}
				}
			});
