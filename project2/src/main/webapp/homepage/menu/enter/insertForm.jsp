...
<body>
                ...
                <div>
                    ...
                    <form action="" method="post" onsubmit="return false;">
                        ...
                        <div id="pw">
                            ...
                            <div>
                            	<input type="password" id="pw_text" name="pw" style="width: 978px; height: 30px;"
    ...
    <script>
		$(function () {
            ...
            let pw = document.getElementById("pw_text");
            
			$("#insert_btn").click(function(){
				if(title.value == "" || content.value == "" || writer.value == "" || pw.value == "") {
					alert("입력 내용을 확인해주세요.");
				} else {
