                    ...
                    <form action="" method="post" onsubmit="return false;">
						...
						<div id="info">
                            ...
                            <table style="width: 1000px; margin-left: 260px;">
                                <tr>
                                    <td>
                                        <textarea cols="63" rows="1" id="training_period" name="training_period"
                                            style="resize: none;" placeholder="교육기간을 입력하세요."></textarea>
                                    </td>

                                    <td>
                                        <textarea cols="64" rows="1" id="recruit_period" name="recruit_period"
                                            style="resize: none;" placeholder="모집기간을 입력하세요."></textarea>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <textarea cols="63" rows="1" id="time" name="time" style="resize: none;"
                                            placeholder="수업시간을 입력하세요."></textarea>
                                    </td>

                                    <td>
                                        <textarea cols="64" rows="1" id="count" name="count" style="resize: none;"
                                            placeholder="인원을 입력하세요."></textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <textarea cols="63" rows="1" id="location" name="location" style="resize: none;"
                                            placeholder="교육장소를 입력하세요."></textarea>
                                    </td>

                                    <td>
                                        <textarea cols="64" rows="1" id="professor" name="professor"
                                            style="resize: none;" placeholder="담당교수를 입력하세요."></textarea>
                                    </td>
                                </tr>
                            </table>
			...
			$("#insert_btn").click(function(){
				if (title.value == "" || content.value == "" || writer.value == "" || professor.value == "" || location.value == "" ||
					...
					if(writer.value.length > 6) {
						...
						$("form").attr("action", "/project2/recruit/addRecruit").submit();
					}
				}
			});
